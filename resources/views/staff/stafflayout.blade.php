    ...
    <div class="row">
      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse" style="background-color: #ffc600">
        <div class="position-sticky pt-3">
          ...
          <ul class="nav flex-column pt-3">
            ...
            <li class="nav-item">
              <a class="nav-link {{ ($active == 'datamahasiswa') ? 'active' : '' }}"
                href="{{ route('datamahasiswa.staff') }}">
            ...
            <li class="nav-item">
              <a class="nav-link {{ ($active == 'datakategori') ? 'active' : '' }}"
                href="{{ route('datakategori.staff') }}">
      ...
      <script>
        $(document).ready(function() {
            $(".ch").chosen({
              no_results_text: "Tidak ada hasil untuk",
              max_height: "100%"
          });
        })
      </script>
