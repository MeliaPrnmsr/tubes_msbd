                    ...
                    <div class="col d-flex align-items-center">
                        <table class="table table-border">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><a href="{{ route('dospem.dosen', ['nama_dosen' => $tugasakhir->nama_promotor1]) }}" class="btn btn-hijau text-start">{{ $tugasakhir->nama_promotor1}}</a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><a href="{{ route('dospem.dosen', ['nama_dosen' => $tugasakhir->nama_promotor2]) }}" class="btn btn-warning text-start">{{ $tugasakhir->nama_promotor2}}</a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><a href="{{ route('dospem.dosen', ['nama_dosen' => $tugasakhir->nama_promotor3]) }}" class="btn btn-danger text-start">{{ $tugasakhir->nama_promotor3}}</a>
                                </td>
                            </tr>
                            @else
                            <tr>
                                ...
                                <td>:</td>
                                <td><a href="{{ route('dospem.dosen', ['nama_dosen' => $tugasakhir->nama_dosen_dospem1]) }}" class="btn btn-hijau text-start">{{ $tugasakhir->nama_dosen_dospem1
                                        }}</a></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><a href="{{ route('dospem.dosen', ['nama_dosen' => $tugasakhir->nama_dosen_dospem2]) }}" class="btn btn-warning text-start">{{ $tugasakhir->nama_dosen_dospem2
                                        }}</a></td>
                            </tr>
                            @endif
                            <tr>
