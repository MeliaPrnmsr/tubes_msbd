            ...
            <div class="row">
                ...
                <div class="col-9">
                    ...
                    <div class="row p-2">
                        ...
                        {{-- kolom sampul start --}}
                        <div class="col-3">
                            <img src="{{asset('storage/'.$tugasakhir->sampul)}}" alt="" class="w-100">
                        </div>
                        {{-- kolom sampul start --}}
                            ...
                            {{-- tab skripsi start --}}
                                <nav>
                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                        ...
                                        <button class="nav-link nav-link-hijau mx-1" id="nav-tugasakhir-tab" data-bs-toggle="tab" data-bs-target="#nav-tugasakhir" type="button" role="tab" aria-controls="nav-tugasakhir" aria-selected="false">Tugas Akhir</button>
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade bg-white" id="nav-pustaka" role="tabpanel" aria-labelledby="nav-pustaka-tab" tabindex="0">
                                        <div class="container">
                                            @if($tugasakhir->dokumenfiles && $tugasakhir->dokumenfiles->file_pustaka)
                                            {{-- Display the document file --}}
                                            <iframe src="{{ asset('storage/'.$tugasakhir->dokumenfiles->file_tugasakhir) }}" width="100%" height="600px"></iframe>
                                        @else
                                            {{-- Tampilkan pesan atau tindakan alternatif jika file tidak tersedia --}}
                                    ...
                                    {{-- isi tab 3 start --}}
                                    <div class="tab-pane fade bg-white" id="nav-tugasakhir" role="tabpanel" aria-labelledby="nav-tugasakhir-tab" tabindex="0">
                                        <div class="container">
                                            @if($tugasakhir->dokumenfiles)
                                                {{-- Display the document file --}}
                                                <embed src="{{'storage/'.$tugasakhir->dokumenfiles->file_tugasakhir}}" type="application/pdf" width="100%" height="600px" />
                                            @endif
                                        </div>
                                    </div>
                                    {{-- isi tab 3 end --}} 
                                    ...
                                    <div class="tab-pane fade bg-white" id="nav-metodologi" role="tabpanel" aria-labelledby="nav-metodologi-tab" tabindex="0">
                                        <div class="container">
                                            @if($tugasakhir->dokumenfiles)
                                                {{-- Display the document file --}}
                                                <embed src="{{'storage/'.$tugasakhir->dokumenfiles->file_metodologi}}" type="application/pdf" width="100%" height="600px" />
                                            @endif
                                        </div>
                                    </div>
                                    {{-- isi tab 4 end --}}
