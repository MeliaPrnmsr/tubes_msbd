                ...
                <div class="col p-2 d-flex justify-content-end">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="{{ route('profile.dosen') }}"><i
                                        class="fa-solid fa-user"></i>&nbsp; Profil</a></li>
                            <li><a class="dropdown-item" href="{{ route('bookmark.dosen') }}"><i
                                        class="fa-solid fa-bookmark"></i>&nbsp; Bookmark</a></li>
                            <li><a class="dropdown-item" href="{{ route('bimbingan.dosen') }}"><i
                                        class="fa-solid fa-chalkboard-user"></i>&nbsp; Bimbingan Saya</a></li>
