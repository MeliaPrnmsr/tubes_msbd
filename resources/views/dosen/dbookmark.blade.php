  ...
  <div class="card border-0">
      <div class="card-body">
        <div class="row d-flex justify-content-center">
          <div class="col-8">
            <form action="/dbookmark" method="get">
              <div class="input-group">
                <input class="form-control border-end-0 border rounded-pill" type="text" value="{{ request('search')}}" id="search" name="search" placeholder="cari berdasarkan judul/tahun terbit/tipe tugas akhir/prodi">
      ...
      <div class="alert alert-repository-no" role="alert">
        <small><i class="fa-solid fa-circle-info"></i>&nbsp; Tidak ada Tugas Akhir yang disimpan.</small>
      </div>
  @else      
        ...
        <div class="card-body mx-auto justify-content-center" style="width: 90%">
          <div class="row bg-hijau shadow p-3 mb-2">
            ...
            <div class="col-2 text-center">Kategori</div>
          ...
          <div class="row shadow p-3 mb-2 align-items-center">
            ...
            <div class="col-2 text-center">
              <a href="{{ route('detail.dosen', ['id_tugasakhir' => $bookmark->id_tugasakhir]) }}"
