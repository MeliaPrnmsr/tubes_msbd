...
<div class="container-fluid bg-orange">
    ...
    <div class="d-flex justify-content-center">
        ...
        <a href="{{ route ('aboutus.dosen') }}" class="btn rounded square-btn bg-repository">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-10 mb-2">
                                    ...
                                    <div>
                                        <form class="d-flex justify-content-start w-100" role="search" method="GET" action="{{ route('search.dosen') }}">
                                            <div class="w-75">
        ...
        <div class="card-body">
            <p>
                <b>| Melalui mahasiswa-mahasiswa yang sudah menyelesaikan tugas akhir,
                    saat in sudah terdapat sebanyak <i>{{$totalTugasAkhir}}</i> tugas akhir di dalam repository skripsi
                    ini
                </b>
            </p>
        </div>
    ...
    <div class="row row-cols-3">
        ...
        <div class="col">
            <ul class="list-unstyled text-muted">
                ...
                <li><a href="{{ route('detail.dosen', ['id_tugasakhir' => $skripsi->id_tugasakhir]) }}" class="text-black"><b>{{ Illuminate\Support\Str::limit($skripsi->judul, $limit = 50, $end = '...') }}</b></a></li>
