        ...
        <div class="card mb-3  ">
            <div class="row p-2">
                ...
                <div class="col-10 justify-content-start">
                    ...
                    <small style="font-size: 75%">Penulis : <b
                            class="text-black">{{$result->nama_mahasiswa}}</b></small>
                    <hr>
                    <small style="font-size: 70%"><i>{{ Illuminate\Support\Str::limit($result->abstrak, $limit = 250,
                            $end = '...') }}</i></small>
                </div>
            </div>
        </div>
