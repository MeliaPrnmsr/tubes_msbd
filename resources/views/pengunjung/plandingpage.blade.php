                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-10 mb-2">
                                        ...
                                        <div>
                                            <form class="d-flex justify-content-start w-100" role="search" method="GET" action="/search">
                                                <div class="w-75">
                                                    <input class="form-control me-2 rounded-pill" name="search" type="search" placeholder="Cari Tugas Akhir" aria-label="Search">
                                                </div>
                                                <div>
                                                    <button class="ms-2 btn btn-repository rounded-pill" type="submit">Cari</button>
                                                </div>
                                            </form>
                                        </div>
            ...
            <div class="row row-cols-3">
                ...
                <div class="col">
                    <ul class="list-unstyled text-muted">
                        ...
                        <li><a href="{{ route('detailTugasakhir', ['id_tugasakhir' => $skripsi->id_tugasakhir]) }}" class="text-black">
                            <b>{{ Illuminate\Support\Str::limit($skripsi->judul, $limit = 50, $end = '...') }}</b>
                        </a></li>
