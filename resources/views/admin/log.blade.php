    ...
    <br>
      ...
      <div class="card-body mx-auto justify-content-center" style="width: 90%">
        ...
        <div class="row shadow p-3 mb-2 align-items-center">
          ...
          <div class="col-6">Insert dan Update pada skripsi</div>
          <div class="col-3 text-center">02-12-2023</div>
        ...
        <div class="row shadow p-3 mb-2 align-items-center">
          ...
          <div class="col-6">Kim Min Seok</div>
          <div class="col-3 text-center">02-12-2023</div>
          <div class="col-2 text-center">
            <a href="/detailmahasiswastaff" class="btn btn-repository">Detail</a>
          </div>
        ...
        <div class="row shadow p-3 mb-2 align-items-center">
          ...
          <div class="col-6">Inser dan Update pada skripsi</div>
          <div class="col-3 text-center">02-12-2023</div>
          <div class="col-2 text-center">
            <a href="/detailmahasiswastaff" class="btn btn-repository">Detail</a>
          </div>
