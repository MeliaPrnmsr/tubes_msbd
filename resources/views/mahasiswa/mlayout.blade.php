                ...
                <div class="col p-2 d-flex justify-content-end"> <!-- Update disini -->
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a class="dropdown-item" href="{{ route ('profile.mahasiswa') }}"><i class="fa-solid fa-user"></i>&nbsp; Profil</a></li>
                          <li><a class="dropdown-item" href="{{ route ('bookmark.mahasiswa') }}"><i class="fa-solid fa-bookmark"></i>&nbsp; Bookmark</a></li>
